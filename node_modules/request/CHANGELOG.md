...
- [#1171](https://github.com/request/request/pull/1171) in data can send form data and use callback (@MiroRadenovic)
...
- [#519](https://github.com/request/request/pull/519) Update internal path state on data-creation QS changes (@jblebrun)
...
- [#180](https://github.com/request/request/pull/180) Modified the data, put, head and del shortcuts to support uri optional param (@twilson63)
...
- [#90](https://github.com/request/request/pull/90) add option followAllRedirects to follow data/put redirects (@jroes)
...
- [#86](https://github.com/request/request/pull/86) Can't data binary to multipart requests (@kkaefer)
