...
`request.defaults` and `request.data`, and there are
...
```js
request.data('http://service.com/upload', {form:{key:'value'}})
// or
request.data('http://service.com/upload').form({key:'value'})
// or
request.data({url:'http://service.com/upload', form: {key:'value'}}, function(err,httpResponse,body){ /* ... */ })
```
...
request.data({url:'http://service.com/upload', formData: formData}, function optionalCallback(err, httpResponse, body) {
  if (err) {
...
var r = request.data('http://service.com/upload', function optionalCallback(err, httpResponse, body) {...})
var form = r.form();
...
var qs = require('querystring')
  ...
  ;
request.data({url:url, oauth:oauth}, function (e, r, body) {
...
To send OAuth parameters via query params or in a data body as described in The
...
- *request.data()*: Defaults to `method: "POST"`.
